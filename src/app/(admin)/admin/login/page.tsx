    ...
    <div className="min-h-screen bg-ink flex items-center justify-center px-4">
      <Suspense fallback={
        <div className="flex flex-col items-center gap-4">
          <div className="w-10 h-10 border-4 border-camel/20 border-t-camel rounded-full animate-spin" />
          <p className="text-cream-300 text-xs font-medium uppercase tracking-widest">Loading Portal...</p>
        </div>
      }>
        <LoginFormContent />
      </Suspense>
